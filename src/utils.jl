...
function load_patches()
    ...
    patches2 = load(joinpath(stl10path, "stl_sampled_patches2.jld"), "patches2")
    patches3 = load(joinpath(stl10path, "stl_sampled_patches3.jld"), "patches3")
    patches4 = load(joinpath(stl10path, "stl_sampled_patches4.jld"), "patches4")
    patches5 = load(joinpath(stl10path, "stl_sampled_patches5.jld"), "patches5")
    patches6 = load(joinpath(stl10path, "stl_sampled_patches6.jld"), "patches6")
    patches7 = load(joinpath(stl10path, "stl_sampled_patches7.jld"), "patches7")
    patches8 = load(joinpath(stl10path, "stl_sampled_patches8.jld"), "patches8")
